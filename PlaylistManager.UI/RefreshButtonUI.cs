...
public class RefreshButtonUI : IInitializable, IDisposable
{
	...
	private void SongsLoaded(Loader _, ConcurrentDictionary<string, BeatmapLevel> songs)
	{
		PlaylistLibUtils.playlistManager.RefreshPlaylists(refreshChildren: true);
		int playlistCount = PlaylistLibUtils.playlistManager.GetPlaylistCount(includeChildren: true);
